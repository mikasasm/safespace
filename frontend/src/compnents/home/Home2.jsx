  ...
  return (
    ...
    <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-6">
        <div class="mx-auto mb-8 max-w-screen-sm lg:mb-16">
            <h2 class="mb-4 text-4xl tracking-tight font-extrabold  text-ink">Mental Health</h2>
            <p class="font-light sm:text-xl text-ink">Read about some mental health related topics</p>
        </div> 
        <div class="grid gap-8 lg:gap-16 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
            <div class="text-center text-ink/70">
                ...
                <h3 class="mb-1 text-2xl font-bold tracking-tight text-ink">
                    ADHD
                </h3>
